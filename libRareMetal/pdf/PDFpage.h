...
class PDFPage
   ...
   public:
      ...
      void DrawCheck(double x, double y, double width, double height, double ratio, double line_width = 4.0);
      //void DrawCross()
      ...
      void AddFootNote(double x_pct_offset, const char * note, double y_pct_offset = 0.04, int font_size = 8);
      void AddHeader(const char * title, const char * sub_title, int title_fontsize = 16, int sub_fontsize = 10);
