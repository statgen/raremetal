////////////////////////////////////////////////////////////////////// 
// PDFmanhattan.h 
// (c) 2000-2013 Goncalo Abecasis (c) 2002-2013 Jan Wigginton
// 
...
/* Written by Jan Wigginton modified by Shuang Feng */

#ifndef __PDFMANHATTAN_H__
#define __PDFMANHATTAN_H__
...
class PDFmanhattan : public PDFChartBasics
   {
   public:

      PDFmanhattan();
      virtual ~PDFmanhattan();
      ...
      //                x2 y12 y22 y32 y42...
bool useDataLabels;
StringArray dataLabels;
Vector dataLabelsX,dataLabelsY;

StringArray tickLabels;
Vector tickLabelsPos;
void DrawDataLabels(PDF & pdf);
void DrawTickLabels(PDF & pdf, PDFChartAxis & axis);
void DrawTicks(PDF & pdf, PDFChartAxis & axis);
void DrawInBox(PDF & pdf, double x_0, double y_0, double x_1, double y_1, bool close);
