...
void WritePDF::Draw(PDF & pdf,StringArray & geneLabels,Vector & pvalueAll,Vector & pvalue1,Vector & pvalue5, StringArray & chr, Vector & pos, String title,String demo,bool useDataLabels)
{
   // Setup Q-Q plot
